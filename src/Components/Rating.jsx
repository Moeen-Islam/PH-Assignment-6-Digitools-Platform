...
const Rating = () => {
  return (
    ...
    //       <div className="absolute right-0 top-1/2 -translate-y-1/2 h-25 w-0.5 bg-white/30"></div>
    //     </div>
  ...
  <div className="max-w-300 mx-auto px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-2 md:grid-cols-3 py-10 sm:py-12 md:py-14">
      ...
      <div className="relative flex flex-col items-center justify-center py-6 md:py-0">
        ...
        <p className="text-white/80 text-sm sm:text-base mt-2">Active Users</p>
      ...
      <div className="relative flex flex-col items-center justify-center py-6 md:py-0">
        ...
        <p className="text-white/80 text-sm sm:text-base mt-2">Premium Tools</p>
